...
export default function LoanAmortizationCalculator() {
  ...
  const calculateAmortization = () => {
    ...
    if (!isFinite(currentMonthlyPayment)) {
      ...
      // For example, when monthlyInterestRate is 0, then principal payment should be loanAmount / totalLoanTermMonths
    ...
    for (let i = 1; i <= totalLoanTermMonths; i++) {
      ...
      defaultDueDate.setDate(5); // Assuming payments ESV due on the 5th based on your PDF
