...
- **Compact Single-Line Footer**: © notice plus discreet links to the Personal Page and Portfolio, with a dark/light mode toggle, all on one line.
...
**Toggle Theme:**
- Use the footer’s dark/light mode toggle to change themes.
